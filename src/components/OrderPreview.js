...
import { FaFileAlt, FaBuilding, FaUser, FaBox, FaPalette, FaHashtag, FaMoneyBillWave, FaCalendarAlt, FaRupeeSign, FaShoppingCart, FaCreditCard } from 'react-icons/fa';
      ...
      >
        ...
        >
          <div className="space-y-4">
            <motion.div variants={itemVariants} className="flex items-center gap-3 p-3 bg-gray-50 rounded-xl">
