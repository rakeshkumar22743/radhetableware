...
const SubmitFeedback = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-600 via-emerald-600 to-teal-600 flex items-center justify-center p-6">
      <motion.div
        ...
        >
          ...
          <motion.div variants={itemVariants}>
            ...
            <p className="text-gray-600 text-lg">
              Your input helps us improve our service and provide better
              experiences.
            </p>
          </motion.div>
