...
function Home() {
  ...
  const navLinks = [
    { name: "Home", href: "/" }, // Changed to Next.js path
    { name: "About", href: "/#about" }, // Changed to Next.js path with hash
    { name: "Products", href: "/#products" }, // Changed to Next.js path with hash
    { name: "Contact", href: "/#contact" }, // Changed to Next.js path with hash
  ];
    ...
    <div className="min-h-screen">
          ...
          <div className="flex justify-between items-center h-20">
            <div className="flex items-center">
              <Link href="/" className="flex flex-col items-center">
                ...
                />
                <span className="text-white text-sm mt-1 w-42 text-center">
                  tableware of your choice
                </span>
              </Link>
            </div>
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="container relative z-10">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h2 className="text-3xl md:text-5xl font-semibold mb-8 text-indigo-200">
              Radhe Tableware
            </h2>
      ...
      <section id="about" className="section bg-white">
        <div className="container">
          <h2 className="heading-primary text-center text-indigo-900">
            About Us
          </h2>
          <div className="max-w-4xl mx-auto">
            <p className="text-lg mb-6 text-gray-700">
              Radhe Tablewares has been a prominent name in the crockery
              manufacturing industry for the past 25 years. Established as a
              pioneer in the field, Radhe has solidified its position as one of
              India's leading brands specializing in the production of melamine
              crockery.
            </p>
            <p className="text-lg mb-6 text-gray-700">
              With a legacy spanning over two decades, Radhe Tablewares has
              consistently delivered high-quality products and exceptional
              service to our customers. Our journey began in Ahmedabad, Gujarat,
              where our state-of-the-art manufacturing plant is located.
            </p>
            <div className="grid md:grid-cols-2 gap-8 mt-12">
              <div className="bg-indigo-50 p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                <h3 className="heading-secondary text-indigo-800">
                  Our Commitment
                </h3>
                <p className="text-gray-600">
                  At Radhe, quality is the cornerstone of our business
                  philosophy. We adhere to stringent quality control measures at
              ...
              <div className="bg-indigo-50 p-8 rounded-xl shadow-sm hover:shadow-md transition-shadow duration-300">
                ...
                <p className="text-gray-600">
                  As we look ahead, Radhe Tablewares is poised for continued
                  growth and innovation in the crockery manufacturing industry.
                </p>
              </div>
            </div>
          </div>
      ...
      <section id="products" className="section bg-gray-50">
        <div className="container">
          ...
          <p className="text-center text-lg mb-12 max-w-3xl mx-auto text-gray-700">
            Discover our premium collection of melamine crockery products,
            designed for durability, elegance, and functionality.
          </p>
                ...
                <div className="space-y-6 mt-6">
                  ...
                  <div className="flex items-center space-x-4 group">
                    ...
                    <div>
                      ...
                      <a
                        href="mailto:rgmelamine@gmail.com"
                        className="text-gray-600 hover:text-indigo-600 transition-colors duration-300"
                      >
        ...
        <div className="container">
          <div className="text-center">
            ...
            <p className="text-indigo-300">
              &copy; {new Date().getFullYear()} RG Melamine. All rights
              reserved.
            </p>
          </div>
        </div>
